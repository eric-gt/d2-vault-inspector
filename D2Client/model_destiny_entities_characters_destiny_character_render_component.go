...
type DestinyEntitiesCharactersDestinyCharacterRenderComponent struct {
	...
	Customization *AllOfDestinyEntitiesCharactersDestinyCharacterRenderComponentCustomization `json:"customization,omitempty"`
	...
	PeerView *AllOfDestinyEntitiesCharactersDestinyCharacterRenderComponentPeerView `json:"peerView,omitempty"`
}
