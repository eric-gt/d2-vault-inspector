...
type DestinyDefinitionsDestinyNodeStepDefinition struct {
	...
	DisplayProperties *AllOfDestinyDefinitionsDestinyNodeStepDefinitionDisplayProperties `json:"displayProperties,omitempty"`
	...
	ActivationRequirement *AllOfDestinyDefinitionsDestinyNodeStepDefinitionActivationRequirement `json:"activationRequirement,omitempty"`
	...
	StepGroups *AllOfDestinyDefinitionsDestinyNodeStepDefinitionStepGroups `json:"stepGroups,omitempty"`
