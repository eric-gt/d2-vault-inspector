...
type DestinyMilestonesDestinyMilestoneQuest struct {
	...
	Status *AllOfDestinyMilestonesDestinyMilestoneQuestStatus `json:"status,omitempty"`
	...
	Activity *AllOfDestinyMilestonesDestinyMilestoneQuestActivity `json:"activity,omitempty"`
