...
type DestinyDefinitionsSocketsDestinySocketTypeDefinition struct {
	...
	DisplayProperties *AllOfDestinyDefinitionsSocketsDestinySocketTypeDefinitionDisplayProperties `json:"displayProperties,omitempty"`
	// Defines what happens when a plug is inserted into sockets of this type.
	InsertAction *AllOfDestinyDefinitionsSocketsDestinySocketTypeDefinitionInsertAction `json:"insertAction,omitempty"`
