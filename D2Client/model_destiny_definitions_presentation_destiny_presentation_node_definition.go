...
type DestinyDefinitionsPresentationDestinyPresentationNodeDefinition struct {
	...
	Children *AllOfDestinyDefinitionsPresentationDestinyPresentationNodeDefinitionChildren `json:"children,omitempty"`
	...
	ScreenStyle int32 `json:"screenStyle,omitempty"`
	// The requirements for being able to interact with this presentation node and its children.
	Requirements *AllOfDestinyDefinitionsPresentationDestinyPresentationNodeDefinitionRequirements `json:"requirements,omitempty"`
