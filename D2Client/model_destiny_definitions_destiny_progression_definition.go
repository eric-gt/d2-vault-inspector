...
type DestinyDefinitionsDestinyProgressionDefinition struct {
	...
	Color *AllOfDestinyDefinitionsDestinyProgressionDefinitionColor `json:"color,omitempty"`
	// For progressions that have it, this is the rank icon we use in the Companion, displayed above the progressions' rank value.
	RankIcon string `json:"rankIcon,omitempty"`
	RewardItems []DestinyDefinitionsDestinyProgressionRewardItemQuantity `json:"rewardItems,omitempty"`
