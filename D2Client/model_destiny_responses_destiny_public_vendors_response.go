...
type DestinyResponsesDestinyPublicVendorsResponse struct {
	...
	VendorGroups *AllOfDestinyResponsesDestinyPublicVendorsResponseVendorGroups `json:"vendorGroups,omitempty"`
	...
	Vendors *AllOfDestinyResponsesDestinyPublicVendorsResponseVendors `json:"vendors,omitempty"`
	...
	Categories *AllOfDestinyResponsesDestinyPublicVendorsResponseCategories `json:"categories,omitempty"`
	...
	Sales *AllOfDestinyResponsesDestinyPublicVendorsResponseSales `json:"sales,omitempty"`
	// A set of string variable values by hash for a public vendors context.  COMPONENT TYPE: StringVariables
	StringVariables *AllOfDestinyResponsesDestinyPublicVendorsResponseStringVariables `json:"stringVariables,omitempty"`
}
