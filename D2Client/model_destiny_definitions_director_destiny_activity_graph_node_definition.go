...
type DestinyDefinitionsDirectorDestinyActivityGraphNodeDefinition struct {
	...
	OverrideDisplay *AllOfDestinyDefinitionsDirectorDestinyActivityGraphNodeDefinitionOverrideDisplay `json:"overrideDisplay,omitempty"`
	// The position on the map for this node.
	Position *AllOfDestinyDefinitionsDirectorDestinyActivityGraphNodeDefinitionPosition `json:"position,omitempty"`
