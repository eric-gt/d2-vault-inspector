...
type DestinyEntitiesProfilesDestinyProfileComponent struct {
	...
	UserInfo *AllOfDestinyEntitiesProfilesDestinyProfileComponentUserInfo `json:"userInfo,omitempty"`
	...
	SeasonHashes []int32 `json:"seasonHashes,omitempty"`
	...
	EventCardHashesOwned []int32 `json:"eventCardHashesOwned,omitempty"`
	...
	CurrentSeasonRewardPowerCap int32 `json:"currentSeasonRewardPowerCap,omitempty"`
	// If populated, this is a reference to the event card that is currently active.
	ActiveEventCardHash int32 `json:"activeEventCardHash,omitempty"`
