...
------------ | ------------- | ------------- | -------------
**TierName** | **string** | The name of the tier. | [optional] [default to null]
**Order** | **int32** | If you&#x27;re rendering medals by tier, render them in this order (ascending) | [optional] [default to null]
