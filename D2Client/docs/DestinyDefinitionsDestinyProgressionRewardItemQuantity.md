...
------------ | ------------- | ------------- | -------------
**RewardedAtProgressionLevel** | **int32** |  | [optional] [default to null]
**AcquisitionBehavior** | **int32** |  | [optional] [default to null]
**UiDisplayStyle** | **string** |  | [optional] [default to null]
**ClaimUnlockDisplayStrings** | **[]string** |  | [optional] [default to null]
