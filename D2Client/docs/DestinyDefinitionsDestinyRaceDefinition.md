...
**RaceType** | **int32** | An enumeration defining the existing, known Races/Species for player characters. This value will be the enum value matching this definition. | [optional] [default to null]
...
**GenderedRaceNamesByGenderHash** | **map[string]string** |  | [optional] [default to null]
