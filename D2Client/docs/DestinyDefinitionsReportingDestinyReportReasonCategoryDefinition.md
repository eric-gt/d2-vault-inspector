...
**Reasons** | [**map[string]DestinyDefinitionsReportingDestinyReportReasonDefinition**](Destiny.Definitions.Reporting.DestinyReportReasonDefinition.md) | The specific reasons for the report under this category. | [optional] [default to null]
