...
------------ | ------------- | ------------- | -------------
**DisplayProperties** | [***AllOfDestinyDefinitionsDestinyLocationReleaseDefinitionDisplayProperties**](AllOfDestinyDefinitionsDestinyLocationReleaseDefinitionDisplayProperties.md) | Sadly, these don&#x27;t appear to be populated anymore (ever?) | [optional] [default to null]
...
**NavPointType** | **int32** | The type of Nav Point that this represents. See the enumeration for more info. | [optional] [default to null]
