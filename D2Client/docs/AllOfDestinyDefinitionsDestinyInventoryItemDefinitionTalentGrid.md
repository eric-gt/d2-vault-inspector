# AllOfDestinyDefinitionsDestinyInventoryItemDefinitionTalentGrid
...
**HudDamageType** | **int32** | If the talent grid implies a damage type, this is the enum value for that damage type. | [optional] [default to null]
