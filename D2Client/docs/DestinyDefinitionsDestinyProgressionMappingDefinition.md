...
------------ | ------------- | ------------- | -------------
**DisplayProperties** | [***AllOfDestinyDefinitionsDestinyProgressionMappingDefinitionDisplayProperties**](AllOfDestinyDefinitionsDestinyProgressionMappingDefinitionDisplayProperties.md) | Infrequently defined in practice. Defer to the individual progressions&#x27; display properties. | [optional] [default to null]
