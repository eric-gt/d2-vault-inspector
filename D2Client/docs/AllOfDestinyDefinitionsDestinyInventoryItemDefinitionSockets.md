# AllOfDestinyDefinitionsDestinyInventoryItemDefinitionSockets
...
**SocketEntries** | [**[]DestinyDefinitionsDestinyItemSocketEntryDefinition**](Destiny.Definitions.DestinyItemSocketEntryDefinition.md) | Each non-intrinsic (or mutable) socket on an item is defined here. Check inside for more info. | [optional] [default to null]
**IntrinsicSockets** | [**[]DestinyDefinitionsDestinyItemIntrinsicSocketEntryDefinition**](Destiny.Definitions.DestinyItemIntrinsicSocketEntryDefinition.md) | Each intrinsic (or immutable/permanent) socket on an item is defined here, along with the plug that is permanently affixed to the socket. | [optional] [default to null]
