...
**ActivityDetails** | [***AllOfDestinyHistoricalStatsDestinyHistoricalStatsPeriodGroupActivityDetails**](AllOfDestinyHistoricalStatsDestinyHistoricalStatsPeriodGroupActivityDetails.md) | If the period group is for a specific activity, this property will be set. | [optional] [default to null]
