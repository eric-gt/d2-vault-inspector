...
**CardImagePath** | **string** |  | [optional] [default to null]
**Color** | [***DestinyMiscDestinyColor**](Destiny.Misc.DestinyColor.md) |  | [optional] [default to null]
**DisplayPriority** | **int32** |  | [optional] [default to null]
**ActivityGivingLimit** | **int32** |  | [optional] [default to null]
**ParentCommendationNodeHash** | **int32** |  | [optional] [default to null]
**DisplayActivities** | [**[]DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition**](Destiny.Definitions.Common.DestinyDisplayPropertiesDefinition.md) | The display properties for the the activities that this commendation is available in. | [optional] [default to null]
