...
------------ | ------------- | ------------- | -------------
**DestinyUserInfo** | [***AllOfDestinyHistoricalStatsDestinyPlayerDestinyUserInfo**](AllOfDestinyHistoricalStatsDestinyPlayerDestinyUserInfo.md) | Details about the player as they are known in game (platform display name, Destiny emblem) | [optional] [default to null]
...
**BungieNetUserInfo** | [***AllOfDestinyHistoricalStatsDestinyPlayerBungieNetUserInfo**](AllOfDestinyHistoricalStatsDestinyPlayerBungieNetUserInfo.md) | Details about the player as they are known on BungieNet. This will be undefined if the player has marked their credential private, or does not have a BungieNet account. | [optional] [default to null]
