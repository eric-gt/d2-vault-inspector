...
type DestinyDefinitionsDestinyVendorItemDefinition struct {
	...
	Action *AllOfDestinyDefinitionsDestinyVendorItemDefinitionAction `json:"action,omitempty"`
	...
	VisibilityScope int32 `json:"visibilityScope,omitempty"`
	...
	Unpurchasable bool `json:"unpurchasable,omitempty"`
}
