...
type DestinyDefinitionsDestinyDamageTypeDefinition struct {
	...
	DisplayProperties *AllOfDestinyDefinitionsDestinyDamageTypeDefinitionDisplayProperties `json:"displayProperties,omitempty"`
	...
	Color *AllOfDestinyDefinitionsDestinyDamageTypeDefinitionColor `json:"color,omitempty"`
