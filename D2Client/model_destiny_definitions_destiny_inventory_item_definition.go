...
type DestinyDefinitionsDestinyInventoryItemDefinition struct {
	...
	TooltipNotifications []DestinyDefinitionsDestinyItemTooltipNotification `json:"tooltipNotifications,omitempty"`
	...
	IconWatermark string `json:"iconWatermark,omitempty"`
	...
	IconWatermarkShelved string `json:"iconWatermarkShelved,omitempty"`
	...
	BackgroundColor *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionBackgroundColor `json:"backgroundColor,omitempty"`
	...
	Action *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionAction `json:"action,omitempty"`
	// Recipe items will have relevant crafting information available here.
	Crafting *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionCrafting `json:"crafting,omitempty"`
	...
	Inventory *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionInventory `json:"inventory,omitempty"`
	...
	SetData *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionSetData `json:"setData,omitempty"`
	...
	Stats *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionStats `json:"stats,omitempty"`
	...
	EquippingBlock *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionEquippingBlock `json:"equippingBlock,omitempty"`
	// If this item can be rendered, this block will be non-null and will be populated with rendering information.
	TranslationBlock *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionTranslationBlock `json:"translationBlock,omitempty"`
	...
	Preview *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionPreview `json:"preview,omitempty"`
	...
	Quality *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionQuality `json:"quality,omitempty"`
	// The conceptual \"Value\" of an item, if any was defined. See the DestinyItemValueBlockDefinition for more details.
	Value *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionValue `json:"value,omitempty"`
	...
	SourceData *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionSourceData `json:"sourceData,omitempty"`
	...
	Objectives *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionObjectives `json:"objectives,omitempty"`
	// If this item has available metrics to be shown, this block will be non-null have the appropriate hashes defined.
	Metrics *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionMetrics `json:"metrics,omitempty"`
	...
	Plug *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionPlug `json:"plug,omitempty"`
	// If this item has related items in a \"Gear Set\", this will be non-null and the relationships defined herein.
	Gearset *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionGearset `json:"gearset,omitempty"`
	...
	Sack *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionSack `json:"sack,omitempty"`
	// If this item has any Sockets, this will be non-null and the individual sockets on the item will be defined herein.
	Sockets *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionSockets `json:"sockets,omitempty"`
	// Summary data about the item.
	Summary *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionSummary `json:"summary,omitempty"`
	...
	TalentGrid *AllOfDestinyDefinitionsDestinyInventoryItemDefinitionTalentGrid `json:"talentGrid,omitempty"`
	...
	SpecialItemType int32 `json:"specialItemType,omitempty"`
	...
	ItemSubType int32 `json:"itemSubType,omitempty"`
	...
	BreakerType int32 `json:"breakerType,omitempty"`
	...
	BreakerTypeHash int32 `json:"breakerTypeHash,omitempty"`
	...
	DefaultDamageType int32 `json:"defaultDamageType,omitempty"`
	...
	SeasonHash int32 `json:"seasonHash,omitempty"`
