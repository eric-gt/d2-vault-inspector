...
type DestinyDefinitionsDestinyItemCategoryDefinition struct {
	...
	GrantDestinyBreakerType int32 `json:"grantDestinyBreakerType,omitempty"`
	...
	GrantDestinyItemType int32 `json:"grantDestinyItemType,omitempty"`
	...
	GrantDestinySubType int32 `json:"grantDestinySubType,omitempty"`
	...
	GrantDestinyClass int32 `json:"grantDestinyClass,omitempty"`
