...
type AllOfDestinyResponsesDestinyPublicVendorsResponseSales struct {
	Data map[string]DestinyResponsesPublicDestinyVendorSaleItemSetComponent `json:"data,omitempty"`
