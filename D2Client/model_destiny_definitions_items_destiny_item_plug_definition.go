...
type DestinyDefinitionsItemsDestinyItemPlugDefinition struct {
	...
	ParentItemOverride *AllOfDestinyDefinitionsItemsDestinyItemPlugDefinitionParentItemOverride `json:"parentItemOverride,omitempty"`
	...
	EnergyCapacity *AllOfDestinyDefinitionsItemsDestinyItemPlugDefinitionEnergyCapacity `json:"energyCapacity,omitempty"`
	// IF not null, this plug has an energy cost. This contains the details of that cost.
	EnergyCost *AllOfDestinyDefinitionsItemsDestinyItemPlugDefinitionEnergyCost `json:"energyCost,omitempty"`
}
