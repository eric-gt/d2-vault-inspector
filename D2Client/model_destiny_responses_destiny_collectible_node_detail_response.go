...
type DestinyResponsesDestinyCollectibleNodeDetailResponse struct {
	...
	Collectibles *AllOfDestinyResponsesDestinyCollectibleNodeDetailResponseCollectibles `json:"collectibles,omitempty"`
	...
	CollectibleItemComponents *AllOfDestinyResponsesDestinyCollectibleNodeDetailResponseCollectibleItemComponents `json:"collectibleItemComponents,omitempty"`
}
