...
type DestinyEntitiesCharactersDestinyCharacterComponent struct {
	...
	EmblemColor *AllOfDestinyEntitiesCharactersDestinyCharacterComponentEmblemColor `json:"emblemColor,omitempty"`
	...
	LevelProgression *AllOfDestinyEntitiesCharactersDestinyCharacterComponentLevelProgression `json:"levelProgression,omitempty"`
