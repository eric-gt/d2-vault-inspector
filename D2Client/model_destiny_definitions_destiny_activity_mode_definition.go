...
type DestinyDefinitionsDestinyActivityModeDefinition struct {
	...
	ModeType int32 `json:"modeType,omitempty"`
	// The type of play being performed in broad terms (PVP, PVE)
	ActivityModeCategory int32 `json:"activityModeCategory,omitempty"`
	...
	ActivityModeMappings map[string]int32 `json:"activityModeMappings,omitempty"`
