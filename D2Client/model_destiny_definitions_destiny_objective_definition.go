...
type DestinyDefinitionsDestinyObjectiveDefinition struct {
	...
	DisplayProperties *AllOfDestinyDefinitionsDestinyObjectiveDefinitionDisplayProperties `json:"displayProperties,omitempty"`
	...
	ValueStyle int32 `json:"valueStyle,omitempty"`
	...
	Perks *AllOfDestinyDefinitionsDestinyObjectiveDefinitionPerks `json:"perks,omitempty"`
	// If this objective enables modifications on a player's stats intrinsically, the conditions are defined here.
	Stats *AllOfDestinyDefinitionsDestinyObjectiveDefinitionStats `json:"stats,omitempty"`
	...
	CompletedValueStyle int32 `json:"completedValueStyle,omitempty"`
	// The style to use when the objective is still in progress.
	InProgressValueStyle int32 `json:"inProgressValueStyle,omitempty"`
	...
	UiStyle int32 `json:"uiStyle,omitempty"`
