...
type DestinyEntitiesItemsDestinyItemInstanceComponent struct {
	...
	PrimaryStat *AllOfDestinyEntitiesItemsDestinyItemInstanceComponentPrimaryStat `json:"primaryStat,omitempty"`
	...
	Energy *AllOfDestinyEntitiesItemsDestinyItemInstanceComponentEnergy `json:"energy,omitempty"`
}
