...
type DestinyDefinitionsSocketsDestinyPlugSetDefinition struct {
	...
	DisplayProperties *AllOfDestinyDefinitionsSocketsDestinyPlugSetDefinitionDisplayProperties `json:"displayProperties,omitempty"`
	...
	ReusablePlugItems []DestinyDefinitionsDestinyItemSocketEntryPlugItemRandomizedDefinition `json:"reusablePlugItems,omitempty"`
	...
	IsFakePlugSet bool `json:"isFakePlugSet,omitempty"`
